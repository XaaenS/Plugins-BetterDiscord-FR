...
*/
  ...
  openWindow(type) {
    ...
    const onChangeOrder = el => {
      ...
      el.target.innerText = 'Sort direction: ' + (!this.settings.reverseOrder ? 'Nouveau - Ancien' : 'Ancien - Nouveau'); // maybe a func?
      this.saveSettings();
      this.refilterMessages();
    };
    ...
    this.createModal(
      {
        ...
        cancelText: 'Sort direction: ' + (!this.settings.reverseOrder ? 'Nouveau - Ancien' : 'Ancien - Nouveau'),
