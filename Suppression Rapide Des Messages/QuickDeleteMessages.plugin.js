/**
 * @name Paramètresdesuppressiondesmessagesrapide
 * @description Maintenez la touche Supprimer et cliquez sur un message pour le supprimer rapidement. Ou activez la touche CTRL dans les paramètres puis cliquez sur un message pour le supprimer rapidement.
 * @version 1.0.12
...
module.exports = (() => {
  ...
  const config = {
    main: 'index.js',
    info: {
      name: 'Paramètres  de suppression des messages rapide',
      authors: [
        {
          name: 'Sneax et Ralawette',
          discord_id: '883473712446341200, 372450484876738562',
          github_username: 'Xaaens',
          twitter_username: ''
        }
      ],
      version: '1.0.12',
      ...
      github_raw: 'https://github.com/XaaenS/Plugins-Discord/tree/main'
    },
    changelog: [
      {
        title: 'Fixed',
        ...
        settings: [
          {
            ...
            note: 'Appuyer sur shift pour afficher plus d\'option sur le message dans la barre d\'action aux réactions aux émotes  !',
            id: 'confirmDelete',
            type: 'switch',
            value: false
          },
          {
            name: 'Utilisez CTRL au lieu de Supprimer',
            id: 'ctrlClickDelete',
            type: 'switch',
            value: false
          }
