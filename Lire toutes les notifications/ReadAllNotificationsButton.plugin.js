/**
 * @name Lire toutes les notifications
	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		return class ReadAllNotificationsButton extends Plugin {
			onLoad () {
				...
				this.defaults = {
					general: {
						addClearButton:		{value: true, 	description: "Ajoute un bouton « Effacer les mentions » à la fenêtre contextuelle des mentions récentes"},
						confirmClear:		{value: false, 	description: "Vous demande votre confirmation avant d'effacer les lectures"}
					},
					batch: {
						guilds:				{value: true, 	description: "Serveurs non lus"},
						muted:				{value: false, 	description: "serveurs non lus mis en sourdine"},
						dms:				{value: false, 	description: "DM non lus"}
					}
				};
			...
			getSettingsPanel (collapseStates = {}) {
				...
				settingsItems.push(BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.CollapseContainer, {
					...
					children: Object.keys(this.defaults.general).map(key => BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsSaveItem, {
						...
						title: "Lorsque vous cliquez avec le bouton gauche sur le bouton « Lire tout », marquez les éléments suivants comme lus  :",
						first: false,
						last: true,
				...
				settingsItems.push(BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.CollapseContainer, {
					title: "Liste noire des serveurs",
					collapseStates: collapseStates,
					children: [
						...
						BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
							...
							label: "Activer pour tous les serveurs",
						...
						BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
							...
							label: "Désactiver pour tous les serveurs",
