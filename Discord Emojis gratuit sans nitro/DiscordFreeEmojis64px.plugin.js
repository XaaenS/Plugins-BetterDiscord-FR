/**
 * @name Discord Emojis gratuit
 * @version 1.7
 * @description Associez des emojis si vous n'avez pas de nitro ! Tapez-les ou utilisez le sélecteur d'emoji ! [64px]
...
return function() { return {
    getName: () => "Discord Emojis gratuit",
    getShortName: () => "FreeEmojis",
    getDescription: () => "Associez des emojis si vous n'avez pas de nitro ! Tapez-les ou utilisez le sélecteur d'emoji ! [64px]",
    getVersion: () => "1.7",
    getAuthor: () => "Sneax & Ralawette",
