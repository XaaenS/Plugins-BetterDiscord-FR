/**
 * @name Editeur d'utilisateur
 * @author Sneax & Ralawette
 * @version 4.8.3
 * @description Vous permet de modifier localement les utilisateurs
...
module.exports = (_ => {
	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		return class ModifierUtilisateurs extends Plugin {
			onLoad () {
				this.defaults = {
					types: {
						servers:			{value: true, 		description: "Serveurs"},
						dms:				{value: true, 		description: "Messages directs"},
					},
					places: {
						contextMenu:		{value: true, 		description: "Menu contextuel utilisateur"},
						chatTextarea:		{value: true, 		description: "Zone de texte de discussion"},
						...
						memberList:			{value: true, 		description: "Liste des membres"},
						voiceChat:			{value: true, 		description: "Canaux vocaux"},
						recentDms:			{value: true, 		description: "Notifications par message direct"},
						dmsList:			{value: true, 		description: "Liste de messages directs"},
						dmHeader:			{value: true, 		description: "En-tête du message direct"},
						dmCalls:			{value: true, 		description: "Appels/Partages d'écran"},
						typing:				{value: true, 		description: "Liste de saisie"},
						friendList:			{value: true, 		description: "Liste d'amis"},
						inviteList:			{value: true, 		description: "Liste d'invitations"},
						activity:			{value: true, 		description: "Page d'activité"},
						userPopout:			{value: true, 		description: "Fenêtres contextuelles utilisateur"},
						userProfile:		{value: true, 		description: "Modal de profil utilisateur"},
						autocompletes:		{value: true, 		description: "Autocomplete Menu"},
						guildSettings:		{value: true, 		description: "Paramètres du serveur"},
						quickSwitcher:		{value: true, 		description: "Changement rapide"},
						searchPopout:		{value: true, 		description: "Fenêtre contextuelle de recherche"},
						userAccount:		{value: true, 		description: "Informations sur votre compte"},
						appTitle:			{value: true, 		description: "Titre de l’application Discord (DM)"}
					}
				};
			...
			getSettingsPanel (collapseStates = {}) {
				...
				return settingsPanel = BDFDB.PluginUtils.createSettingsPanel(this, {
					...
					children: _ => {
						...
						settingsItems.push(BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsPanelList, {
							title: "Changer les utilisateurs dans la fenêtre de discussion (Messages, réactions, mentions, etc.) dans:",
